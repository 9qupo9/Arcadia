class PixelRacer {
    constructor() {
        ...
        this.roadOffset = 0; // Add road offset for animation
    ...
    drawCar(x, y, isPlayer, colorScheme = null) {
        ...
        if (isPlayer) {
            // Player car - original orientation
            // Windows
            ...
            const windowY = y + this.carHeight * 0.2 * this.pixelSize;
            this.drawPixelRect(windowX, windowY, windowWidth, windowHeight, colors[2]);

            // Details
            const detailY = y + this.carHeight * this.pixelSize * 0.3;
            this.drawPixelRect(x, detailY, 2, 6, colors[2]);
            this.drawPixelRect(x + (this.carWidth - 2) * this.pixelSize, detailY, 2, 6, colors[2]);
        } else {
            // Obstacle cars - 180 degrees rotated
            // Windows
            const windowWidth = Math.floor(this.carWidth * 0.6);
            const windowHeight = Math.floor(this.carHeight * 0.2);
            const windowX = x + (this.carWidth * this.pixelSize - windowWidth * this.pixelSize) / 2;
            ...
            // Details
            const detailY = y + this.carHeight * this.pixelSize * 0.1;
            this.drawPixelRect(x, detailY, 2, 6, colors[2]);
            this.drawPixelRect(x + (this.carWidth - 2) * this.pixelSize, detailY, 2, 6, colors[2]);
        }
    }
    ...
    drawRoad() {
        ...
        // Animate road markers at the same speed as obstacles
        this.roadOffset = (this.roadOffset - this.speed) % 40; // Moving at the same speed as obstacles
